        ...
        items: [
          {
            question_number: 1,
            question_id: 1,
            question_text: 'Gerakan memindahkan seluruh anggota tubuh dari satu tempat ke tempat lain disebut gerak...',
            options: ['Lokomotor', 'Non-lokomotor', 'Manipulatif', 'Keseimbangan'],
            selected_option: 0,
            selected_text: 'Lokomotor',
            correct_option: 0,
            correct_text: 'Lokomotor',
            is_correct: true,
            points: 20,
            max_points: 20
          },
          {
            question_number: 2,
            question_id: 2,
            question_text: 'Aktivitas menekuk lutut dan mengayun lengan di tempat termasuk contoh gerak dasar...',
            options: ['Lokomotor', 'Non-lokomotor', 'Manipulatif', 'Irama'],
            selected_option: 1,
            selected_text: 'Non-lokomotor',
            correct_option: 1,
            correct_text: 'Non-lokomotor',
            is_correct: true,
            points: 20,
            max_points: 20
          },
          {
            question_number: 3,
            question_id: 3,
            question_text: 'Tujuan utama melakukan pemanasan sebelum melakukan aktivitas fisik atau olahraga adalah...',
            options: ['Mengurangi rasa haus', 'Mencegah terjadinya cedera otot', 'Membuat tubuh cepat lelah', 'Menambah nafsu makan'],
            selected_option: 1,
            selected_text: 'Mencegah terjadinya cedera otot',
            correct_option: 1,
            correct_text: 'Mencegah terjadinya cedera otot',
            is_correct: true,
            points: 20,
            max_points: 20
          },
          {
            question_number: 4,
            question_id: 4,
            question_text: 'Salah satu contoh bentuk latihan yang paling tepat untuk melatih daya tahan kardiorespirasi adalah...',
            options: ['Lari santai (jogging) jarak menengah', 'Push-up 3 kali', 'Tidur telentang', 'Berdiri tegak 5 detik'],
            selected_option: 0,
            selected_text: 'Lari santai (jogging) jarak menengah',
            correct_option: 0,
            correct_text: 'Lari santai (jogging) jarak menengah',
            is_correct: true,
            points: 20,
            max_points: 20
          },
          {
            question_number: 5,
            question_id: 5,
            question_text: 'Sikap tubuh yang benar saat melakukan gerakan mendarat setelah melompat adalah...',
            options: ['Kaki lurus kaku', 'Kedua lutut sedikit ditekuk mengeper', 'Mendarat dengan satu tumit', 'Badan condong ke belakang'],
            selected_option: 0,
            selected_text: 'Kaki lurus kaku',
            correct_option: 1,
            correct_text: 'Kedua lutut sedikit ditekuk mengeper',
            is_correct: false,
            points: 0,
            max_points: 20
          }
